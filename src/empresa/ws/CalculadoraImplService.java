 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ws.empresa/", wsdlLocation = "http://localhost:4040/SOAP/sueldo?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:4040/SOAP/sueldo?wsdl");
